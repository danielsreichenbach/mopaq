...
pub fn compress_with_method(data: &[u8], method: u8) -> Result<Vec<u8>, mopaq::Error> {
...
pub fn test_round_trip(data: &[u8], method: u8) -> Result<Vec<u8>, mopaq::Error> {
    ...
    if decompressed != data {
        return Err(mopaq::Error::compression(format!(
