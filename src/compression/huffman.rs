...
// Implement Eq explicitly - this is needed because we're only comparing weights,
// not the actual nodes, so we need to tell Rust this is a valid equivalence relation
